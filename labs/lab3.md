...
Functional:
    ...
    - The system must offer the user a self-assessment test
    ...
    Nice-to-have:
    - It would be nice for the system to have Python integration
...
Non-functional:
    ...
    - The system will not have to offer multi-language support